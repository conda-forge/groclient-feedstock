...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/groclient-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11216&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/groclient-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `groclient` can be installed with:

```
conda install groclient
```

It is possible to list all of the versions of `groclient` available on your platform with:
